...
use super::fine::Fine;
use crate::vello_common::blurred_rounded_rect::BlurredRoundedRectangle;
use crate::vello_common::coarse::Wide;
use crate::vello_common::color::{AlphaColor, Srgb};
use crate::vello_common::colr::{ColrPainter, ColrRenderer};
use crate::vello_common::encode::{EncodeExt, EncodedPaint};
use crate::vello_common::flatten::Line;
use crate::vello_common::glyph::{GlyphRenderer, GlyphRunBuilder, GlyphType, PreparedGlyph};
use crate::vello_common::kurbo::{Affine, BezPath, Cap, Join, Rect, Shape, Stroke};
use crate::vello_common::mask::Mask;
use crate::vello_common::paint::{Image, Paint, PaintType};
use crate::vello_common::peniko::color::palette::css::BLACK;
use crate::vello_common::peniko::{BlendMode, Compose, Fill, Gradient, Mix};
use crate::vello_common::peniko::{Font, ImageQuality};
use crate::vello_common::pixmap::Pixmap;
use crate::vello_common::strip::Strip;
use crate::vello_common::tile::Tiles;
use crate::vello_common::{flatten, peniko, strip};
...
impl RenderContext {
    ...
    pub fn push_layer(
        ...
        let opacity = opacity.map(|opacity| (opacity * 255.0) as u8);
        ...
        match prepared_glyph.glyph_type {
            ...
            GlyphType::Colr(glyph) => {
                ...
                let glyph_pixmap = {
                    ...
                    ctx.render_to_pixmap(&mut pix, RenderMode::OptimizeSpeed);
