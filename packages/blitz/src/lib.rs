...
//! # Command Execution
//!
//! The `command` module provides safe command execution using the desktop-commander MCP server.
//!
...
#[doc(inline)]
/// Re-export of [`blitz_text`]. Advanced text shaping and layout with international support
pub use blitz_text as text;
#[doc(inline)]
