...
impl DomEventKind {
    pub fn discriminant(&self) -> u8 {
        match self {
            DomEventKind::MouseMove => 0,
            DomEventKind::MouseDown => 1,
            DomEventKind::MouseUp => 2,
            DomEventKind::Click => 3,
            DomEventKind::KeyPress => 4,
            DomEventKind::KeyDown => 5,
            DomEventKind::KeyUp => 6,
            DomEventKind::Input => 7,
            DomEventKind::Ime => 8,
...
impl FromStr for DomEventKind {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            "mousemove" => Ok(DomEventKind::MouseMove),
            ...
            "input" => Ok(DomEventKind::Input),
            "change" => Ok(DomEventKind::Change),
